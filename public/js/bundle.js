...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2V2aW5yYW5nZWwiLCJhIjoiY2xvbG15c21wMWN2OTJxcHF2dDl0YXhzNSJ9.KSK7oEiJ_o28oSqafLTqcw';
  var map = new mapboxgl.Map({
    container: 'map',
    // style: 'mapbox://styles/mapbox/streets-v11',
    style: 'mapbox://styles/kevinrangel/clp75ak2d012s01qja7xs90wo',
    scrollZoom: false //longitude - latititude
...
var hideAlert = exports.hideAlert = function hideAlert() {
  var el = document.querySelector('.alert'); //Removing child element
...
var showAlert = exports.showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert alert--".concat(type, "\">").concat(msg, "</div>");
  ...
  _regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') location.reload(true); //Force reload from the server and not from browser cache
...
var loginForm = document.querySelector('.form'); // const logOutBtn = document.querySelector('.nav__el--logout');
