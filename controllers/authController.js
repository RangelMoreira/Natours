...
const cookieOptions = {
  ...
  httpOnly: true, //Prevents the cookie from being changed by the browser
};

if (process.env.NODE_ENV === 'production') cookieOptions.secure = true; //The cookie will only be sent when HTTPS
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  user.passwordConfirm = req.body.passwordConfirm;
  await user.save();
  //User.findAndUpdate will not work as instead!
